...
DECLARE sumlevel STRING DEFAULT 'tract';
...
For record IN (
    ...
    DO
    SET gcs_uri = FORMAT('gs://geospatial-projects/teu_site_similarity/acs/census_tract/%s_tract_state_all_%d.csv',record.table_id, year);
